        ...
        <div>
          ...
          <div className='grid gap-2 mt-2'>
            <div className='border border-green-600 px-4 py-2 rounded bg-green-50 w-fit'>
              <p className='font-semibold text-lg lg:text-xl'>Blinkit: {DisplayPriceInRupees(blinkit)}</p>
            </div>
            <div className='border border-green-600 px-4 py-2 rounded bg-green-50 w-fit'>
              <p className='font-semibold text-lg lg:text-xl'>Zepto: {DisplayPriceInRupees(zepto)}</p>
            </div>
            <div className='border border-green-600 px-4 py-2 rounded bg-green-50 w-fit'>
              <p className='font-semibold text-lg lg:text-xl'>Instamart: {DisplayPriceInRupees(instamart)}</p>
            </div>
          </div>
        </div>
